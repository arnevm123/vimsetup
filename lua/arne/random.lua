return {
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "]r", '<cmd>lua require("illuminate").goto_next_reference(wrap)<cr>', { noremap = true, silent = true })
			vim.keymap.set("n", "[r", '<cmd>lua require("illuminate").goto_prev_reference(wrap)<cr>', { noremap = true, silent = true })
