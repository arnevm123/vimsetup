...
keymap("n", "<leader>fu", ":Telescope live_grep default_text=<C-r><C-w><cr>", opts)
keymap("n", "<leader>fp", ':lua require("telescope.builtin").live_grep({ default_text = "<C-r>"" })<cr>', opts)
...
keymap("n", "<leader>gU", "<cmd>Gitsigns undo_stage_buffer<cr>", opts)
keymap("n", "<leader>go", "<cmd>Telescope git_status<cr>", opts)
keymap("n", "<leader>gd", "<cmd>Gitsigns diffthis HEAD<cr>", opts)
keymap("n", "<leader>gc", "<cmd>Gvdiffsplit!<CR>", opts)
keymap("n", "<leader>gC", "<cmd>Gdiffsplit!<CR>", opts)
